			...
			<?php
				...
				if(isset($workingList['created_at'])){
					if($workingList['created_at'] !== ''){
						echo '<a href="'.$GLOBALS['canvasURL'].'/courses/'.$courseID.'/wiki/primary-template" target="_blank" class="btn btn-primary btn-block btn-large">Edit Primary Template Page</a>';
					}
				} else {
					echo '<a href="'.$GLOBALS['canvasURL'].'/courses/'.$courseID.'/wiki/primary-template" target="_blank" class="btn btn-block btn-large primary">Add Primary Template Page</a>';
				}
				...
				if(isset($workingList2['created_at'])){
					if($workingList2['created_at'] !== ''){
						echo '<a href="'.$GLOBALS['canvasURL'].'/courses/'.$courseID.'/wiki/secondary-template" target="_blank" class="btn btn-primary btn-block btn-large">Edit Secondary Template Page</a>';
					}
				} else {
					echo '<a href="'.$GLOBALS['canvasURL'].'/courses/'.$courseID.'/wiki/secondary-template" target="_blank" class="btn btn-block btn-large secondary">Add Secondary Template Page</a>';
				}
